        ...
        try {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    console.warn('Failed to delete from Auth (Backend returned error)');
                }
            } catch (serverError) {
            ...
            if (authDeleted) {
                success(`User ${selectedUser.name || selectedUser.email} deleted from Database and Auth.`);
            } else {
                // Show a warning if Auth deletion failed
                showError(`User deleted from Database, but NOT from Auth (Email will remain in use). Check Server.`);
            }
                                        ...
                                        <tr key={user.id}>
                                            ...
                                            <td data-label="Actions">
                                                <div className="action-buttons">
                                                    ...
                                                    >
                                                        <svg fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" /></svg>
                                                    </button>
                                                    <button
